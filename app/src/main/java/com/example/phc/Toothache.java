...
public class Toothache extends AppCompatActivity {
    ...
    MyDatabaseToothacheHelper myDBItemToothache;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDBItemToothache = new MyDatabaseToothacheHelper(Toothache.this);
        ...
        customAdapter = new CustomAdapter(Toothache.this, this, username, rating, comment);
        recyclerView4.setAdapter(customAdapter);
        recyclerView4.setLayoutManager(new LinearLayoutManager(Toothache.this));
        ...
        arrowBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Toothache.this, ListPages.class);
        ...
        btnComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (txtUsername.getText().toString().equals("")){
                    ...
                    MyDatabaseToothacheHelper myDBItemToothache = new MyDatabaseToothacheHelper(Toothache.this);
                    myDBItemToothache.insertCommentToothache(txtUsername.getText().toString(),
                            ratingBar.getRating(),
...
//                    Toast.makeText(Item1.this, ratingBar.getRating() + edtComment.getText().toString() + txtUsername.getText().toString(), Toast.LENGTH_SHORT).show();
    ...
    void displayData1(){
        Cursor cursor = myDBItemToothache.readAllDataToothache();
    ...
    void loginMessage(){
        ...
        builder.setPositiveButton("LogIn", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent a = new Intent(Toothache.this, LogInPage.class);
                startActivity(a);
            }
        });
